...
def train_cnn():
    ...
    x_raw, y_raw, df, labels = data_helper.load_data_and_labels(train_file,cat_file,desc_col,ispickle=False)
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            def dev_step(x_batch, y_batch,writer=None):
                ...
                step,summaries, loss, acc, num_correct = sess.run([global_step, dev_summary_op,cnn.loss, cnn.accuracy, cnn.num_correct], feed_dict)
                time_str = datetime.datetime.now().isoformat()
